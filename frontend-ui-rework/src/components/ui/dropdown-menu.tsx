...
// Shared by every row in the menu. `items-center` is NOT baked in: call sites in
// this app stack a label over a disabled-reason line with `flex-col
// items-start`, and hard-coding centring here would fight them.
const menuItemBase =
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(menuItemBase, "items-center data-[state=open]:bg-accent", inset && "pl-8", className)}
    {...props}
  >
    {children}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(menuItemBase, "items-center", inset && "pl-8", className)}
    {...props}
  />
));
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ref={ref}
    className={cn(menuItemBase, "items-center py-1.5 pl-7 pr-2", className)}
    checked={checked}
    {...props}
  >
