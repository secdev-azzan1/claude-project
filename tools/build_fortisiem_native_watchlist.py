"""
Native build of watchlist -- brand new entity, GET-only (no Jolt transform needed: the response is
already an array of named-field objects). Single call returns all 59 watchlists (no pagination).
Triggered once per run off fortisiem.maximum__run_metadata, same fan-out point incident uses.

'entries' is a nested array of up to 13-field entry objects (non-null on 12/59 watchlists, 31615
entries total) -- kept NESTED as an Avro array-of-records per the supervisor spec (entries has no
dedicated endpoint of its own, so it is not split into a separate entity). No live sample with a
populated entries array was captured; entry field types below follow this codebase's existing
convention (*Time/count/id/custId fields -> long, everything else -> free-text string) rather than
...
ENTRY_RECORD = {
    ...
    "fields": [
        {"name": "ageOut", "type": ["null", "string"], "default": None},
        {"name": "count", "type": ["null", "long"], "default": None},
        {"name": "custId", "type": ["null", "long"], "default": None},
        {"name": "dataCreationType", "type": ["null", "string"], "default": None},
        {"name": "description", "type": ["null", "string"], "default": None},
        {"name": "entryValue", "type": ["null", "string"], "default": None},
        {"name": "expiredTime", "type": ["null", "long"], "default": None},
        {"name": "firstSeen", "type": ["null", "long"], "default": None},
        {"name": "id", "type": ["null", "long"], "default": None},
        {"name": "lastSeen", "type": ["null", "long"], "default": None},
        {"name": "naturalId", "type": ["null", "string"], "default": None},
        {"name": "state", "type": ["null", "string"], "default": None},
        {"name": "triggeringRules", "type": ["null", "string"], "default": None},
    ],
}
...
def build_schema():
    ...
    fields.extend([
        ...
        {"name": "entries", "type": ["null", {"type": "array", "items": ENTRY_RECORD}], "default": None},
        {"name": "id", "type": ["null", "long"], "default": None},
        {"name": "isCaseSensitive", "type": ["null", "boolean"], "default": None},
        {"name": "name", "type": ["null", "string"], "default": None},
        {"name": "naturalId", "type": ["null", "string"], "default": None},
        {"name": "topGroup", "type": ["null", "boolean"], "default": None},
        {"name": "valuePattern", "type": ["null", "string"], "default": None},
        {"name": "valueType", "type": ["null", "string"], "default": None},
    ])
    return {"type": "record", "name": "fortisiem_watchlist_raw_avro", "namespace": "bronze.fortisiem", "fields": fields}
...
def main():
    ...
    fetch_id = create_processor(token, "org.apache.nifi.processors.standard.InvokeHTTP", f"fortisiem.{ENTITY}__fetch", {
        "HTTP Method": "GET",
        "HTTP URL": "#{SOURCE_API_BASE}/watchlist/all",
    ...
    extract_id = create_processor(token, "org.apache.nifi.processors.standard.EvaluateJsonPath", f"fortisiem.{ENTITY}__extract", {
        ...
        "watchlist_custid": "$.custId",
        "watchlist_natural_id": "$.naturalId",
    ...
    set_ids_id = create_processor(token, "org.apache.nifi.processors.attributes.UpdateAttribute", f"fortisiem.{ENTITY}__set_ids", {
        "entity": ENTITY,
        "object_id": "${watchlist_natural_id}",
        "api_path": "GET #{SOURCE_API_BASE}/watchlist/all",
    ...
    headers_id = create_processor(token, "org.apache.nifi.processors.attributes.UpdateAttribute", f"fortisiem.{ENTITY}__set_public_headers", {
        ...
        "customer_tenant_organization": "${watchlist_custid}",
        ...
        "object_id_composite": "fortisiem:${watchlist_custid}:${entity}:${object_id}",
